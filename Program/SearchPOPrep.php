 ...
 <meta charset="utf-8">
	...
	<div class="container-fluid">
		<nav class="navbar navbar-inverse" role="navigation"> 
	        ...
	        <div class="row">
	        	...
	        	<form action="SearchPOPrep.php" role="form" method="post">
	        			<div class="form-group">
	        				<label for="barcode">Search by PO: </label>
		...
		<?php
			...
			{
			  echo "<form method=\"post\" action=\"EditPO.php\">";
			  echo "<tr>"; 
			  ...
			  echo "<td><input type=\"hidden\" name=\"PO_Number\" id=\"PO_Number\" value=\"{$row[PO_Request_ID]}\"/></td>";
			  echo "</tr>";
			  echo "</form>";
			}
			echo "</table>";
