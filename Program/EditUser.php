<html class="no-js">
  <html class="no-js">
    <head>
        ...
        <title>List Of Authorized System Users</title>
    ...
    <body>​
		<div class="container-fluid"> 
	        ...
	        <h1>List of Authorized System Users</h1>
			      <?php
			      //need to rework entire file to work with AddItem.html
					...
					echo "<div class=\"table-responsive\">";
				      ...
				      {
				      	echo "<form method=\"post\" action=\"EditUserPrep.php\">";
				        echo "<tr>"; 
						echo "<td><input type=\"submit\" name=\"submit\" value=\"EDIT\"/></td>"; 
				        echo "<td><input disabled type=\"text\" name=\"last\" value=\"{$row['LastName']}\"/></td>";
				        echo "<td><input disabled type=\"text\" name=\"first\" value=\"{$row['FirstName']}\"/></td>";
				        echo "<td><input disabled type=\"text\" name=\"email\" value=\"{$row['Email']}\"/></td>"; 
						echo "<td><input type=\"hidden\" name=\"User_ID\" id=\"User_ID\" value=\"{$row[User_ID]}\"/></td>";
				        echo "</tr>"; 
						echo "</form>";
					  }
					  echo "</table>";
