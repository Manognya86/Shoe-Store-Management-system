	...
	<div class="container-fluid">
		<nav class="navbar navbar-inverse" role="navigation"> 
	        ...
	        <div class="row">
	        	...
	        	<form action="SearchInvItemPrep.php" role="form" method="post">
	        			<div class="form-group">
	        				<label for="barcode">Search by Item Number: </label>
	        				<input type="number" class="form-control" id="query" name="query">
	        			</div>
		...
		<?php
			...
			{
			  echo "<form method=\"post\" action=\"EditInvItemPrep.php\">";
			  echo "<tr>"; 
			  echo "<td><a href=EditInvItemPrep.php ><input type=\"submit\" name=\"submit\" value=\"EDIT\"/></a></td>";
