						...
						elseif (ctype_alpha($_POST['brand']) != true)
						{
						    $message = "Brand must contain alphabet letters only.";
						}
						// verify that the last name is the correct length
						elseif (strlen( $_POST['brand']) < 1)
						{
						    $message = 'Incorrect Length for brand';
						}
						else 
						{
						...
						{
						$Vari = mysqli_real_escape_string($con, $_POST['brand']);
						// Insert data into mysql 
						$sql="INSERT IGNORE INTO BRAND(Name) VALUES('$Vari')";
